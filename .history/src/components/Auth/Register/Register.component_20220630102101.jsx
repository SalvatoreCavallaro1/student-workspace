...
const Register = () => {
    ...
    const corsi = [
        { name:"years" ,key: 'I', text: 'Ingegneria Informatica', value: 'Inf' },
        { name:"years", key: 'E', text: 'Ingegneria Industriale', value: 'Elettr' },
        { name:"years", key: 'In', text: 'Ingegneria Meccanica', value: 'Indu' },
      ]
      const anni = [
