...
const Register = () => {
    ...
    const [errorState, seterrorState]= errorState(errors);
    ...
    const checkForm = () =>
    {
        ...
        {
            seterrorState((error) => error.concat({message : "Le due password non coincidono"}))
            return false;
        }
        return true;
    }
    ...
    const formaterrors = () =>
    {
        errorState.map((error,index) => <p key={index}></p>)
    }
