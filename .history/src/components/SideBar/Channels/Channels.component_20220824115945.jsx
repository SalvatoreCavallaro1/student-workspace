...
const Channels = (props) => {
    ...
    const languageOptions = [
        { key: 'Ingegneria Informatica primo anno', text: 'Ingegneria Informatica primo anno', value: 'Ingegneria Informatica primo anno' },
...
useEffect ( () => {
    ...
    if (snapshot.exists()) {
        ...
        console.log(courses);
        Object.keys(courses).forEach(key => console.log(courses[key]));
        console.log(languageOptions);
        Object.keys(languageOptions).forEach(key => console.log(languageOptions[key]));
