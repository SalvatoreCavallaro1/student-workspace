...
useEffect ( () => {
    ...
    if (snapshot.exists()) {
        ...
        CoursesState.map((course) => {
          ...
          Object.keys(coursesobj).forEach(key => courses.id=coursesobj[key].id,courses.key=coursesobj[key].key,courses.text=coursesobj[key].text,courses.value=coursesobj[key].value,courses.years=coursesobj[key].years);
