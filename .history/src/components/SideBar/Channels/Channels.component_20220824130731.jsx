...
useEffect ( () => {
    ...
    if (snapshot.exists()) {
        ...
        CoursesState.map((course) => {
          ...
          Object.keys(coursesobj).forEach(courses.id=coursesobj.id,courses.key=coursesobj.key,courses.text=coursesobj.text,courses.value=coursesobj.value,courses.years=coursesobj.years);
