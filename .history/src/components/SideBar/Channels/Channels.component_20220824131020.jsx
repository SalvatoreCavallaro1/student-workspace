...
useEffect ( () => {
    ...
    if (snapshot.exists()) {
        ...
        CoursesState.map((course) => {
          ...
          Object.entries(coursesobj).forEach
          ( ([key,value])=>
            coursesobj[key,value]=courses[key,value]
          /*
            courses.id=coursesobj.id,
            courses.key=coursesobj.key,
            courses.text=coursesobj.text,
            courses.value=coursesobj.value,
            courses.years=coursesobj.years*/
