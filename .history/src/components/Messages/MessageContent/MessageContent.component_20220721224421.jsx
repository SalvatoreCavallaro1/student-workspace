...
const MessageContent = (props) =>{
    ...
    <Comment.Content className={props.ownMessages ? "ownMessages": null}>
        ...
        {props.message.attachment && props.message.extension!="pdf"  ? <Image src={props.message.attachment} href={props.message.attachment}/> :
            <Comment.Text> </Comment.Text>
        }
        {props.message.attachment && props.message.extension==="pdf"  ? <Icon name="file pdf" href={props.message.attachment}/> :
            <Comment.Text></Comment.Text>
        }
