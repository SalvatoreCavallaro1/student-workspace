...
import {ref,onChildAdded, off,child} from "firebase/database";
...
const Messages = (props) =>{
    ...
    //onChildAdded(query: Query, callback: (snapshot: DataSnapshot, previousChildName?: string | null | undefined) => unknown, cancelCallback?: ((error: Error) => unknown) | undefined): Unsubscribe
    useEffect(()=> {
        if(props.channel)
        {
        setMessagesState([]);
