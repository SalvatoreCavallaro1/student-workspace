...
const MessageInput = (props) =>{
    ...
    const onSubmit = () => {
        if(messageState) //controllo se l'utente ha inserito dei dati
        {
            ...
            const newmessage = push(child(ref(firebase.db), 'messages'),props.channel.id).set(set(createMessageInfo())).then(()=> console.log('sent'))
            .catch((error) => console.log(error));
            
            
            /*const updates = {};
            updates['messages' + newmessage] = createMessageInfo();
