...
const MessageInput = (props) =>{
    ...
    const uploadAttachments = (file,contentType) => {
        ...
        //var re = /(?:\.([^.]+))?$/; 
        //var ext = re.exec("file.name.with.dots.txt")[1]; // "txt" var ext = re.exec("file.txt")[1]; // "txt" var ext = re.exec("file")[1]; // undefined var ext = re.exec("")[1]; // undefined var ext = re.exec(null)[1]; // undefined var ext = re.exec(undefined)[1]; // undefined 
        console.log(ext);
