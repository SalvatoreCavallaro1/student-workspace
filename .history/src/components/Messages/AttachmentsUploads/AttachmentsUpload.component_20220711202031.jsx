...
export const AttachmentsUpload =(props) => {
    ...
    const submit =()=> {
        ...
        if(fileState && acceptedTypes(MimeTypes.lookup(fileState.name)))  
        ...
        //posso così controllare se l'etensione + inclusa all'interno del vettore delle estensioni supportate
        {
            ...
            props.uploadAttachments(fileState,MimeTypes.lookup(fileState.name)); //passo così il file e l'estensione
            props.onClose();
            setFilesState(null);
        }
    }
